...
pub fn assert_realy_vault(
    program_id: &Pubkey,
    realy: &AccountInfo,
    realy_vault: &AccountInfo,
) -> Result<u8, ProgramError> {
    let path = &[
        program_id.as_ref(),
        realy.key.as_ref(),
    ...
    assert_derivation(&program_id, &realy_vault, path)
}

pub fn assert_esrealy_vault(
    program_id: &Pubkey,
    esrealy: &AccountInfo,
    esrealy_vault: &AccountInfo,
) -> Result<u8, ProgramError> {
    let path = &[
        program_id.as_ref(),
        esrealy.key.as_ref(),
    ...
    assert_derivation(&program_id, &esrealy_vault, path)
}

pub fn assert_transfer_authority(
    program_id: &Pubkey,
    realy: &AccountInfo,
    esrealy: &AccountInfo,
